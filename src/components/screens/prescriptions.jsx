            ...
            <div>
                ...
                <div className="container-fluid" id="main">
                    <div className="row row-offcanvas row-offcanvas-left">
                        <div className="col-md-3 col-lg-2 sidebar-offcanvas pl-0" id="sidebar" role="navigation" style={{backgroundColor:"#171010"}}>
                            <ul className="nav flex-column sticky-top pl-0 pt-5 mt-3">
                                <li className="nav-item"><a className="text-light nav-link" href="/dashboard">Home</a></li> 
                                <li className="nav-item"><a className="text-light nav-link" href="/upcoming-sessions">Upcoming Sessions</a></li>
                                <li className="nav-item"><a className="text-light nav-link" href="/previous-sessions">Previous Sessions</a></li>
                                <li className="nav-item"><a className="text-light nav-link" href="/routines">Routines</a></li>
                                <li className="nav-item"><a className="text-light nav-link" href="/prescriptions">Prescriptions</a></li>
