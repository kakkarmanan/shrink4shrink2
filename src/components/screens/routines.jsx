...
class Routines extends React.Component{
    routines=[
        {
            "source":"https://firebasestorage.googleapis.com/v0/b/shrink4shrink.appspot.com/o/Mess%20reciept.pdf?alt=media&token=4a6a3b00-1785-4df1-a9bc-887e5513b01f",
        },
        {
            "source":"https://firebasestorage.googleapis.com/v0/b/shrink4shrink.appspot.com/o/Mess%20reciept.pdf?alt=media&token=4a6a3b00-1785-4df1-a9bc-887e5513b01f",
        },
                    ...
                    <div className="col main pt-5 mt=3 border border-dark" style={{backgroundColor:"#303030"}}>
                        ...
                        <div className="row">
                            <form class="ses-info">
                                ...
                                <button type="submit" style={{color:"#303030"}}>Upload</button>
                            </form>
                        </div>
                        <div className="row">
                            {this.state.data.map(ele=>(
                                ...
                                <iframe src={ele.source} style={{width:"220px", height:"300px",overflow:"hidden"}} frameborder="0" scrolling="no" ></iframe>
                                <a href={ele.source} style={{position:"absolute" ,top:"0", left:"0", display:"inline-block", width:"500px", height:"500px", ZIndex:"5"}}></a>
                                </Tilt>
                            </div>
                            ))}
                        </div>
